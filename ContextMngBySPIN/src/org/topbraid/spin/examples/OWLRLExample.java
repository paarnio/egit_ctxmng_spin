...
public class OWLRLExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("Loading domain ontology..."); //VPA: temporalily in other place
		//OntModel queryModel = loadModelWithImports("http://owl.cs.manchester.ac.uk/co-ode-files/ontologies/pizza.owl");
		//OntModel queryModel = loadModelWithImports("http://130.88.198.11/co-ode-files/ontologies/pizza.owl"); 
